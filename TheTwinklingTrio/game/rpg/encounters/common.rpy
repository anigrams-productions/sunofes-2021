...
label t3_encounter_scenario_level_up_nerdy:
    ...
    menu:
        ...
        "Style":
            ...
            "[game_state.t3_player_nerdy.name] now has [game_state.t3_player_nerdy.style] Style."
        "Magic":
            $ game_state.t3_player_nerdy.magic += 1
            "[game_state.t3_player_nerdy.name] now has [game_state.t3_player_nerdy.magic] Magic."
        "Wisdom":
            $ game_state.t3_player_nerdy.wisdom += 1
            "[game_state.t3_player_nerdy.name] now has [game_state.t3_player_nerdy.wisdom] Wisdom."
...
label t3_encounter_scenario_level_up_sporty:
    ...
    menu:
        ...
        "Style":
            ...
            "[game_state.t3_player_sporty.name] now has [game_state.t3_player_sporty.style] Style."
        "Magic":
            $ game_state.t3_player_sporty.magic += 1
            "[game_state.t3_player_sporty.name] now has [game_state.t3_player_sporty.magic] Magic."
        "Wisdom":
            $ game_state.t3_player_sporty.wisdom += 1
            "[game_state.t3_player_sporty.name] now has [game_state.t3_player_sporty.wisdom] Wisdom."
...
label t3_encounter_scenario_level_up_perfect:
    ...
    menu:
        ...
        "Style":
            ...
            "[game_state.t3_player_perfect.name] now has [game_state.t3_player_perfect.style] Style."
        "Magic":
            $ game_state.t3_player_perfect.magic += 1
            "[game_state.t3_player_perfect.name] now has [game_state.t3_player_perfect.magic] Magic."
        "Wisdom":
            $ game_state.t3_player_perfect.wisdom += 1
            "[game_state.t3_player_perfect.name] now has [game_state.t3_player_perfect.wisdom] Wisdom."
